    ...
    <section>
      <div className="relative max-w-6xl mx-auto flex items-center justify-center px-4 xl:px-0">
        ...
        <div className="relative z-10 w-full flex flex-col items-center md:items-start justify-center py-8 sm:py-20">
          <h1 className="text-2xl md:text-3xl lg:text-[32px] font-bold text-gray-700">
            Mau cari kos?
          </h1>

          <p className="mt-1 md:text-lg lg:text-xl text-gray-700">
            Dapatkan infonya dan langsung sewa di Mamikos.
          </p>

          {/* Search */}
          <div className="mt-7 flex h-12 w-90 md:w-100 lg:w-110 items-center rounded-lg bg-white p-1 shadow-[0_5px_15px_rgba(0,0,0,0.08)]">
